        ...
        <div className="flex-column">
          <div className="bg-yellow-400 w-95 p-10 box-shadow rounded-lg ">
            ...
            {!isLoggedIn &&
              ...
              <Link to='/signup' className="flex justify-center items-end text-xs">
              Click here to &nbsp;
              <p className="signUpbtn flex items-end text-xl">
              Sign-Up
              </p>
              </Link>
              </button>
              ...
              <button className="btn-home">
              <Link to='/signin' className="flex justify-center items-end text-xs">
                Click here to  &nbsp;
              <p className="signUpbtn flex items-end text-xl">
              Sign-In
              </p>
